package com.toonsdomain.basketcounter;
...
public class MainActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Team A
		ScoreForTeamAView = findViewById(R.id.team_a_score);
		displayFaultTeamAView = findViewById(R.id.faultsTeamA_value);
		displayReboundsTeamAView = findViewById(R.id.reboundsTeamA_value);
		displayStealsTeamAView = findViewById(R.id.stealsTeamA_value);
		//Team B
		ScoreForTeamBView = findViewById(R.id.team_b_score);
		displayFaultTeamBView = findViewById(R.id.faultsTeamB_value);
		displayReboundsTeamBView = findViewById(R.id.reboundsTeamB_value);
		displayStealsTeamBView = findViewById(R.id.stealsTeamB_value);
	}
